"""JWKS TLS trust store + hibaüzenet tesztek a nav_invoice.jwt_auth modulhoz.
...
import nav_invoice.jwt_auth as auth_mod
...
def _make_request(method: str, path: str = "/invoices", token: str = "valid-token"):
    scope = {
        "type": "http",
        "method": method,
        "path": path,
