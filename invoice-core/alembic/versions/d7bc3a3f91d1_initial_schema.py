...
Revision ID: d7bc3a3f91d1
Revises: 
Create Date: 2026-06-16 23:56:17.393094
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_wise_transaction_invoice_file_id'), 'wise_transaction', ['invoice_file_id'], unique=False)
