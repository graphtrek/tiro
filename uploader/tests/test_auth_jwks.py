"""JWKS TLS trust store + hibaüzenet tesztek a uploader.auth modulhoz.
...
import uploader.auth as auth_mod
...
def _make_request(method: str, path: str = "/uploads", token: str = "valid-token"):
    scope = {
        "type": "http",
        "method": method,
        "path": path,
